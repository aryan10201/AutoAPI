...
class V1Extractor:
    ...
    def _save_results(self):
        results_path = os.path.join(self.results_dir, "v1_names.json")
...
def main(results_dir: str):
    extractor = V1Extractor(results_dir)
    extractor.extract_names()

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Run V1 name extractor')
